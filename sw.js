const CACHE_NAME = "askcreate-app-v1706-kvarovi-samo-kartica";
const APP_SHELL = [
  "./",
  "./index.html",
  "./style.css?v=1706-kvarovi-samo-kartica",
  "./script.js?v=1706-kvarovi-samo-kartica",
  "./manifest.json?v=1706-kvarovi-samo-kartica",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
